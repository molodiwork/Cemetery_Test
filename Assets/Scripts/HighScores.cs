...
{
    const string privateCode = "mqGYUeXRdEOC1ZlZfP7r8QkIoeekAgH0GjWcTyIMOk3Q";  //Key to Upload New Info
    const string publicCode = "65357fb58f40bb11fc50a944";   //Key to download
